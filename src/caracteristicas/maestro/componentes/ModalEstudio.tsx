...
import { XCircle, User, ListChecks, Clock, DollarSign } from 'lucide-react';
          ...
          {modo === 'ADD' && (
            <section className="bg-slate-900 p-8 rounded-4xl text-white">
              ...
              <input
                ...
                name="claveDueno"
                autoComplete="off"
                className="w-full p-3 mb-4 bg-slate-800 border border-slate-700 rounded-xl text-pink-400 font-mono text-sm uppercase"
                value={formulario.assignedKey}
                onChange={(e) =>
                  setFormulario((p) => ({ ...p, assignedKey: e.target.value.toUpperCase() }))
                }
                required={modo === 'ADD'}
              />
              <label
                className="text-[9px] font-black text-slate-400 uppercase"
                htmlFor="clave-clientes"
              >
                Clave clientes
              </label>
              <input
                ...
                name="claveClientes"
                autoComplete="off"
                className="w-full p-3 bg-slate-800 border border-slate-700 rounded-xl text-purple-400 font-mono text-sm uppercase"
                value={formulario.clientKey}
                onChange={(e) =>
                  setFormulario((p) => ({ ...p, clientKey: e.target.value.toUpperCase() }))
                }
                required={modo === 'ADD'}
              />
            </section>
