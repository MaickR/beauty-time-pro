      ...
      <div className="mb-4 space-y-3">
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 outline-none focus:border-pink-300"
          />
        </label>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {serviciosOrdenados
          .filter((servicio) => {
            ...
            const coincideCategoria =
              categoriaFiltro === 'Todos' || categoriaServicio === categoriaFiltro;
        ...
        {serviciosOrdenados.length > 0 &&
          serviciosOrdenados.filter((servicio) => {
            ...
            <p className="col-span-full py-8 text-center text-sm font-bold text-slate-400 italic">
              No hay servicios que coincidan con el filtro actual.
            </p>
          )}
